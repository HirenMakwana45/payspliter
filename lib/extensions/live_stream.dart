...
//
//     // Retrieve existing data item from the map or create a new one
//     _DataItem item = _mDataItemsMap[key] ?? _DataItem();
//
//     // Initialize the callbacks list if null
//     item.callbacks ??= [];
//
//     // Add the new callback
//     item.callbacks!.add(callback);
//
//     // Save the item back to the map
//     _mDataItemsMap[key] = item;
//
//     // Dispatch current value to the callback if it exists
//     if (item.value != null) {
//       callback(item.value);
//     }
//   }
